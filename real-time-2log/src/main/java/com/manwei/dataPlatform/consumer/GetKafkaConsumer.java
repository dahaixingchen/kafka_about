package com.manwei.dataPlatform.consumer;
...
public class GetKafkaConsumer {
    ...
    private int seeeion_timeout_ms = 10000;
    private int heartbeat_interval_ms = 3000;
    private int max_poll_interval_ms = 300000;
    ...
    public GetKafkaConsumer(){

    }
    public GetKafkaConsumer(String bootstrap_servers, String group_id){
        this.bootstrap_servers = bootstrap_servers;
        this.group_id = group_id;
    }
